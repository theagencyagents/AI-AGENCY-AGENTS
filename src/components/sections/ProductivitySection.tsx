...
const ProductivitySection = () => {
  ...
  const productivityTools = aiTools
    .filter((tool) => tool.category === "🚀 Productivity & Personal Growth")
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            🚀 Productivity & Personal Growth Tools
          </h2>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">
            Boost your productivity and personal development with these
            AI-powered tools designed to streamline your workflow
          </p>
        </motion.div>
        ...
        <div className="mt-16 text-center">
          ...
          >
            <Link
              to="/tools?category=🚀 Productivity & Personal Growth"
