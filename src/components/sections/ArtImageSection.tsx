...
const ArtImageSection = () => {
  // Filter tools by category
  const artImageTools = aiTools
    .filter((tool) => tool.category === "🌄 Art & Image Generator")
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            🌄 Art & Image Generator Collection
          </h2>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">
            Explore our collection of AI art and image generation tools that can
        ...
        <div className="mt-16 text-center">
          ...
          >
            <Link
              to="/tools?category=🌄 Art & Image Generator"
              className="text-white hover:text-white"
            >
              Explore All Art & Image Tools
