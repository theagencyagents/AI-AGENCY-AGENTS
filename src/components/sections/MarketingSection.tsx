...
const MarketingSection = () => {
  ...
  const marketingTools = aiTools
    .filter((tool) => tool.category === "💰 Sales & Marketing")
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-3xl mx-auto">
            Boost your marketing efforts with AI tools designed to enhance your
            sales, advertising, and customer engagement
          </p>
        </motion.div>
        ...
        <div className="mt-16 text-center">
          ...
          >
            <Link
              to="/tools?category=💰 Sales & Marketing"
