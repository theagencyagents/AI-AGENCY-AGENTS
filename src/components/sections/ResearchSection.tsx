...
const ResearchSection = () => {
  ...
  const researchTools = aiTools
    .filter((tool) => tool.category === "🎓 Research Assistant")
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-3xl mx-auto">
            Enhance your research with AI tools that help you find, understand,
            and analyze academic papers and information
          </p>
        </motion.div>
        ...
        <div className="mt-16 text-center">
          ...
          >
            <Link
              to="/tools?category=🎓 Research Assistant"
