...
const ContentSeoSection = () => {
  // Filter tools by category
  const contentSeoTools = aiTools
    .filter((tool) => tool.category === "📠 Content Generation & Seo")
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-3xl mx-auto">
            Discover powerful AI tools for creating SEO-optimized content, blog
            posts, marketing copy, and more
          </p>
        </motion.div>
        ...
        <div className="mt-16 text-center">
          ...
          >
            <Link
              to="/tools?category=📠 Content Generation & Seo"
              className="text-white hover:text-white"
            >
              Explore All Content & SEO Tools
...
export default ContentSeoSection;
