...
const VideoSection = () => {
  ...
  const videoTools = aiTools
    .filter((tool) => tool.category === "🎬 Video Generation & Editing")
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-3xl mx-auto">
            Create professional videos with AI-powered tools that make video
            production faster and easier than ever
          </p>
        </motion.div>
        ...
        <div className="mt-16 text-center">
          ...
          >
            <Link
              to="/tools?category=🎬 Video Generation & Editing"
