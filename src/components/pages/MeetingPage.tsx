...
const MeetingPage = () => {
  return (
    <div className="min-h-screen bg-black transition-colors duration-300">
      ...
      <div className="fixed bottom-40 left-20 w-80 h-80 rounded-full bg-teal-500/30 blur-3xl pointer-events-none z-0 animate-float-medium" />

      {/* Subtle background overlay */}
      <div className="fixed inset-0 bg-[url('https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=1200&auto=format&fit=crop')] bg-cover bg-center opacity-30 pointer-events-none z-0" />
        ...
        <main>
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Enhance your meetings with AI tools that record, transcribe, and
