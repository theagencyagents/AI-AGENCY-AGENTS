        ...
        <main>
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              AI Directories Collection
            </h1>
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Browse our comprehensive collection of AI directories, ranked by
              domain authority and usefulness
            </p>
          </motion.div>

          <DirectoriesSection
            showAll={true}
            title="All AI Directories"
            description="Explore the complete collection of AI directories from across the web, sorted by ranking"
          />
        </main>
