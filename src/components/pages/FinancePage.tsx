...
const FinancePage = () => {
  return (
    <div className="min-h-screen bg-black transition-colors duration-300">
      ...
      <div className="fixed inset-0 bg-[url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1200&auto=format&fit=crop')] bg-cover bg-center opacity-30 pointer-events-none z-0" />
