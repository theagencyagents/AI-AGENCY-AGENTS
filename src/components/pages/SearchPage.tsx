...
const SearchPage = () => {
  return (
    <div className="min-h-screen bg-black transition-colors duration-300">
      ...
      {/* Floating orbs */}
      <div className="fixed top-20 right-20 w-64 h-64 rounded-full bg-amber-500/40 blur-3xl pointer-events-none z-0 animate-float-slow" />
      <div className="fixed bottom-40 left-20 w-80 h-80 rounded-full bg-violet-500/30 blur-3xl pointer-events-none z-0 animate-float-medium" />
        ...
        <main>
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Discover AI-powered search engines that provide comprehensive
              answers with sources and context
            </p>
          </motion.div>
