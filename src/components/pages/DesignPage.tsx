...
const DesignPage = () => {
  return (
    <div className="min-h-screen bg-black transition-colors duration-300">
      ...
      <div className="fixed inset-0 bg-[url('https://images.unsplash.com/photo-1558655146-d09347e92766?q=80&w=1200&auto=format&fit=crop')] bg-cover bg-center opacity-30 pointer-events-none z-0" />
