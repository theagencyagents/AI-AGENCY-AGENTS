        ...
        <main>
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Discover our handpicked selection of the best AI tools to enhance
          ...
          <ToolsSection
            title="All AI Tools"
            description="Explore our complete collection of AI tools, carefully selected for maximum impact"
          />
        </main>
